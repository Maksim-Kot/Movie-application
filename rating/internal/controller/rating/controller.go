...
func (c *Controller) PutRating(ctx context.Context,
...
func (s *Controller) StartIngestion(ctx context.Context) error {
	...
	for e := range ch {
		if err := s.PutRating(ctx, e.RecordID, e.RecordType,
